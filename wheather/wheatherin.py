...
# wheatherin.py
# python3 implementation of bash programming task https://github.com/pmarf/bashBootcamp/blob/main/README.md
# version 1.0 2026-03-31 hr
# call: python3 wheatherin.py <city1> <city2> ... <cityN>
# or
#       python3 wheatherin.py
# the call without a city, some examples mostly with Umlaut, will be used
#
# in contrast to the original, Umlaute are handled correctly
...
print('{:12s} {:16s}  {:9s}  {:9s} {:12s} {:12s} {:12s}'.format('Stadt', 'Zeit', '  lat', '  lon', 'Temperatur', 'Windgeschw.', 'Richtung'))
...
for city in cities:
    ...
    print('{:12s} {:16s}  {:9.6f}  {:9.6f} {:8.1f} {:10.1f} {:12.0f}'.format(city, time,
